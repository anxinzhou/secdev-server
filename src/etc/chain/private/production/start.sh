...
if [ $node = "node1" ]
then
geth --gasprice 0 --txpool.pricelimit 0  --mine --datadir node1/ --syncmode 'full' --port 30311 --rpc --rpcaddr 'localhost' \
 	--rpcport 8540 --rpcapi 'personal,db,eth,net,web3,txpool,miner' --rpccorsdomain '*'  \
 	--ws --wsport 8450 --wsapi="personal,db,eth,net,web3,txpool,miner" --wsorigins "*" --targetgaslimit '9000000000000'  --networkid 1515  \
...
then
geth --gasprice 0 --txpool.pricelimit 0  --mine --datadir node2/ --syncmode 'full' --port 30312 --rpc --rpcaddr 'localhost' \
 --rpcport 8541 --rpcapi 'personal,db,eth,net,web3,txpool,miner' --rpccorsdomain '*'  \
 --ws --wsport 8451 --wsapi="personal,db,eth,net,web3,txpool,miner" --wsorigins "*" --targetgaslimit '9000000000000'  --networkid 1515  \
