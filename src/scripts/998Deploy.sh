...
then
		node contractUtils deploy "../etc/contracts/PvcERC998.sol" ComposableTopDown -r $2 -k "../etc/chain/private/testnet/node/keystore/authority1" -p "321" -a '["testSlot","ts"]' -s
else
		echo $1
